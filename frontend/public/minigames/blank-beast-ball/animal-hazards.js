...
const HAZARD_MODEL_CDN = 'https://cdn.jsdelivr.net/gh/Green003-CPAIOS/blank-wars-models@main/minigames/blank-beast-ball/';
...
class AnimalHazardManager {
    ...
    async loadAnimalModel(animalName) {
        const modelPath = HAZARD_MODEL_CDN + `${animalName}.glb`;
        try {
