...
class HexGridSystem {
    ...
    static ring(center, radius) {
        if (radius === 0)
            return [center];
        const results = [];
        let hex = this.createHex(center.q + radius, center.r - radius);
        const directions = [
            { q: -1, r: 1, s: 0 }, // Southwest
            { q: -1, r: 0, s: 1 }, // West
            { q: 0, r: -1, s: 1 }, // Northwest
...
exports.HexGridSystem = HexGridSystem;
