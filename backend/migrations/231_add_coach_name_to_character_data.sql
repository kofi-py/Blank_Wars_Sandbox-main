-- Migration 231: Add coach_name to get_full_character_data
-- Adds users.coach_name to the IDENTITY package for all domains
-- Coach name is derived via user_characters.user_id -> users.coach_name
...
STRICT MODE: Raises exception if user_character not found or required fields missing.
...
IDENTITY also includes coach_name for the owning user.';
