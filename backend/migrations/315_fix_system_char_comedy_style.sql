-- Migration 315: Fix get_system_character_data to use comedy_style from characters table
--
-- The function was reading comedy_style from the deprecated comedian_styles table
-- via comedian_style_id JOIN. Now it reads directly from characters.comedy_style.
...
BEGIN
  ...
  v_identity := jsonb_build_object(
    ...
    -- Comedy style - NOW FROM CHARACTERS TABLE DIRECTLY
...
VALUES (315, '315_fix_system_char_comedy_style')
