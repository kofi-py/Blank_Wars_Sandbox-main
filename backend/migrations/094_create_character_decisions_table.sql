...
CREATE INDEX idx_character_decisions_character_id ON character_decisions(character_id);
CREATE INDEX idx_character_decisions_domain ON character_decisions(domain);
CREATE INDEX idx_character_decisions_timestamp ON character_decisions(timestamp DESC);
CREATE INDEX idx_character_decisions_status ON character_decisions(status);
CREATE INDEX idx_character_decisions_domain_type ON character_decisions(domain, decision_type);
