-- Migration 194: Create get_full_character_data() PostgreSQL function
-- Single source of truth for character data - eliminates TypeScript mapping layer
-- STRICT MODE: Raises exception if any required data is missing
-- Uses 3 packages (IDENTITY, COMBAT, PSYCHOLOGICAL) concatenated with || to stay under 100 arg limit
...
BEGIN
  ...
  -- Note: team_context.team_id is varchar, teams.id is uuid
  -- user_characters.user_id is text, teams.user_id is text
  -- =====================================================
  SELECT tc.*
  INTO v_tc
  ...
  -- =====================================================
  -- 4. BUILD IDENTITY PACKAGE (64 args)
  -- Who they are, their story, their situation
  -- =====================================================
  ...
  -- =====================================================
  -- 5. BUILD COMBAT PACKAGE (58 args)
  -- Fighting stats, resources, and abilities
  -- =====================================================
  ...
  -- Mental/emotional state, mood, and preferences
  -- =====================================================
...
COMMENT ON FUNCTION get_full_character_data(TEXT, TEXT) IS
'Returns complete character data as JSONB in 3 packages: IDENTITY, COMBAT, PSYCHOLOGICAL.
STRICT MODE: Raises exception if character/user_character not found or required fields missing.
Parameters: p_character_id (base character), p_userchar_id (user_characters instance)';

COMMIT;

-- Log migration
INSERT INTO migration_log (version, name)
VALUES (194, '194_create_get_full_character_data_function')
