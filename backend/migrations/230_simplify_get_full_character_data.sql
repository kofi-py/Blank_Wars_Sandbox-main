-- Migration 230: Simplify get_full_character_data to accept only userchar_id
-- The canonical character_id is now derived internally from user_characters.character_id
-- This eliminates redundancy and prevents mismatch errors
