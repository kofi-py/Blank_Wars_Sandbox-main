-- Migration: Fix auto_unlock_starters function
-- Description: Updates the function to use correct column names (s.id instead of s.spell_id)
...
BEGIN
    ...
    SELECT NEW.id, s.id, 0, 1  -- FIXED: s.spell_id -> s.id
...
VALUES (252, '252_fix_auto_unlock_starters')
